  ...
  function checkMemberPlan() {
    ...
    if (userData && userData.metaData && (userData.metaData.start_date_wf_eco || userData.metaData.start_date_wf_pack) && userData.planConnections) {
      ...
      if (daysSinceStart >= daysForLevel2) {
        ...
        if (courseTimeLeftPrice && userData.metaData.start_date_wf_pack) courseTimeLeftPrice.textContent = "60€";
        ...
        if (courseTimeLeftPrice && userData.metaData.start_date_wf_pack) courseTimeLeftPrice.textContent = "120€";
