...
window.addEventListener('load', function() {
  ...
  function checkMemberPlan() {
    ...
    // Logique pour ajuster l'affichage en fonction du plan et du niveau d'accès
    ...
    // Autres éléments d'UI à ajuster ici selon les besoins...
  }
